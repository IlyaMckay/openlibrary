import { matchMiscFiles, matchSmallMediumCovers, matchLargeCovers,
    matchStaticImages, matchStaticBuild, matchArchiveOrgImage, matchAuthorEditPage, matchEditionEditPage } from '../../../openlibrary/plugins/openlibrary/js/service-worker-matchers';
